...
internal class StringFormattingTest {
    ...
    fun testDoubleToStringTrimTrailingZeros() {
        ...
        assertEquals("0.01", 0.01.toString(2, trimTrailingZeros = true))
        assertEquals("0.01", 0.01.toString(3, trimTrailingZeros = true))
        assertEquals("0.001", 0.001.toString(3, trimTrailingZeros = true))
        assertEquals("0.001", 0.001.toString(4, trimTrailingZeros = true))
        assertEquals("0.0001", 0.0001.toString(4, trimTrailingZeros = true))
        assertEquals("0.0001", 0.0001.toString(5, trimTrailingZeros = true))
        assertEquals("0", 0.00000001.toString(5, trimTrailingZeros = true))

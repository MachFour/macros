...
public class Config {
    ...
    static final Path INIT_SQL = Paths.get("/home/max/devel/macros-java/src/sql/macros-db-create.sql");
    static final Path TRIG_SQL = Paths.get("/home/max/devel/macros-java/src/sql/macros-db-triggers.sql");
    static final Path DATA_SQL = Paths.get("/home/max/devel/macros-java/src/sql/macros-initial-data.sql");

...
public interface MacrosDataSource {
    ...
    void saveFoodPortions(@NotNull Meal m) throws SQLException;
    ...
    @NotNull Meal getOrCreateMeal(@NotNull DateStamp day, @NotNull String name) throws SQLException;
    ...
    <M extends MacrosEntity<M>> int saveObjects(Collection<? extends M> objects, ObjectSource objectSource) throws SQLException;
